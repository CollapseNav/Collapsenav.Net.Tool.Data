...
[Collection("c")]
public class EntityModifyRepositoryTest
{
    ...
    public EntityModifyRepositoryTest()
    {
        Provider = DIConfig.GetProvider();
        Repository = GetService<IEntityModifyRepository<TestModifyEntity>>();
        Read = GetService<IEntityQueryRepository<TestModifyEntity>>();
    }
    ...
    {
        var repo = GetService<IEntityModifyRepository<TestModifyEntity>>();
        await repo.AddAsync(new TestModifyEntity());
        repo.Dispose();
        repo = GetService<IEntityModifyRepository<TestModifyEntity>>();
    ...
    //     IEntityModifyRepository<TestModifyEntity> repo = new ModifyRepository<TestModifyEntity>(GetService<IDB<TestDbContext>>());
    //     await repo.AddAsync(new TestModifyEntity());
    //     repo.Dispose();
    ...
    [Fact, Order(27)]
    public async Task EntityModifyRepositoryAddOrUpdateTest()
    {
